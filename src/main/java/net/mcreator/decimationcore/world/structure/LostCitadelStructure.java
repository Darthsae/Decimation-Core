...
package net.mcreator.decimationcore.world.structure;
...
public class LostCitadelStructure extends DecimationCoreModElements.ModElement {
	public LostCitadelStructure(DecimationCoreModElements instance) {
		super(instance, 5);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("decimation_core", "lostcitadel"));
						if (template == null)
							return false;
