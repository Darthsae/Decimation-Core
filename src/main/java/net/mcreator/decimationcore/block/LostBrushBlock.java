...
public class LostBrushBlock extends DecimationCoreModElements.ModElement {
	@ObjectHolder("decimation_core:lost_brush")
	public static final Block block = null;
	public LostBrushBlock(DecimationCoreModElements instance) {
		super(instance, 11);
	}
