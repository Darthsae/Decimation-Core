...
public class AncientsTableBlock extends DecimationCoreModElements.ModElement {
	@ObjectHolder("decimation_core:ancients_table")
	public static final Block block = null;
	@ObjectHolder("decimation_core:ancients_table")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AncientsTableBlock(DecimationCoreModElements instance) {
		super(instance, 2);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("ancients_table"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("ancients_table");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("ancients_table");
		}
